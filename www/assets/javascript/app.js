(function() {
              ...
              ons.notification.prompt({
                ...
                callback: function(name) {
                  ...
                  $.ajax({
                    ...
                    success: function(msg){
                      $timeout(function(){
                        infrared.name = msg["response"]["infrared"]["name"]
                      })
                      ons.notification.alert({
                        message: '' + (name||undefined) + 'に変更しました！',
                        modifier: "material"
                      });
                    },
                    error: function(error){
  ...
  .controller('InfraredGroupController', function($scope, $timeout, infraredGroupModel) {
              ...
              ons.notification.prompt({
                ...
                callback: function(name) {
                  ...
                  $.ajax({
                    ...
                    success: function(msg){
                      $timeout(function(){
                        group.name = msg["response"]["group"]["name"]
                      })
                      ons.notification.alert({
                        message: '' + (name||undefined) + 'に変更しました！',
                        modifier: "material"
    ...
    this.delete = function(group,index) {
      ons.notification.confirm({
        message: 'グループを削除します',
        modifier: 'material',
        callback: function(answer) {
          switch(answer){
            ...
            case 1:
              $.ajax({
                ...
                success: function(msg){
                  $timeout(function(){
                    infraredGroupModel.groups.splice(index,1)
                  })
                  ons.notification.alert({
                    message: '' + (group.name||undefined) + 'を削除しました',
                    modifier: "material"
                  });
                },
                error: function(error){
